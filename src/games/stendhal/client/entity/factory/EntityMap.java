...
import games.stendhal.client.entity.UweBag;
...
public final class EntityMap {
	...
	private static void register() {
		...
		//...
		register("item", "club", "mansword.png", UseableItem.class);
		...
		register("uwebag", null, null, UweBag.class);
	...
	public static Class< ? extends IEntity> getClass(final String type,
		...
		if (result == null) {
		 ...
		 System.out.println(type + "," + eclass + "," + subClass + " "+ result);
		return result;
	}
}
