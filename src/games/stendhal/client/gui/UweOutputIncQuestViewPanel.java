...
public class UweOutputIncQuestViewPanel extends JComponent implements ContentChangeListener,CloseListener{
	/**
	 * 
	 */
	...
	{
		private UweOutputIncQuestViewPanel self;
		public FirstStageBtnHandler(UweOutputIncQuestViewPanel self)
		{
			this.self=self;
		}
	...
	{
		private UweOutputIncQuestViewPanel self;
		public SecondStageBtnHandler(UweOutputIncQuestViewPanel self)
		{
			this.self=self;
		}
