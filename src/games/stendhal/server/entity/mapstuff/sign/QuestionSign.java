...
import games.stendhal.server.events.ShowQuestionListEvent;

/**
 * A sign for a ShopList.
 */
public class QuestionSign extends Sign implements UseListener {
	 ...
	 *            true, if this sign is for items sold by an NPC
	 */
	public QuestionSign(final String name, final String title, final String caption, final boolean seller) {
		super();
		this.shopName = name;
		this.title = title;
	...
	public boolean onUsed(RPEntity user) {
		...
		ShowQuestionListEvent event = new ShowQuestionListEvent(title, caption, itemList);
