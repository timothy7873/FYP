...
//		player.addAttribute("private_text", Type.LONG_STRING, (byte) (Definition.HIDDEN | Definition.VOLATILE));
		...
		// Meets recorder - needed for quest
		player.addRPSlot("!meets", 1, Definition.HIDDEN);
		...
		player.addRPEvent(UweSpeakTextEvent.RPCLASS_NAME, Definition.PRIVATE);
		player.addRPEvent(UweCombinatorEvent.RPCLASS_NAME, Definition.PRIVATE);
