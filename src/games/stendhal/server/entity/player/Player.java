...
public class Player extends RPEntity implements UseListener {
	...
	private final PlayerLootedItemsHandler itemCounter = new PlayerLootedItemsHandler(
			this);
	private final UweMeetRecording meetRec = new UweMeetRecording(this);
	...
	/*  UWE */
	/**
	 * Checks if the player has ever Met a creature, with or without the help
	 * of any other player.
	 *
	 * @param name
	 *            of the creature to check.
	 * @return true iff this player has ever Met this creature.
	 */
	public boolean hasMet(final String name) {
		return meetRec.hasMet(name);
	}

	/**
	 * Checks if the player has ever 'solo Met' a creature, i.e. without the
	 * help of any other player.
	 *
	 * @param name
	 *            of the creature to check.
	 * @return true iff this player has ever Met this creature on his own.
	 */
	public boolean hasMetSolo(final String name) {
		return meetRec.hasMetSolo(name);
	}

	/**
	 * Checks if the player has ever 'shared Met' a creature, i.e. with the
	 * help of any other player.
	 *
	 * @param name
	 *            of the creature to check.
	 * @return true iff this player has ever Met this creature in a team.
	 */
	public boolean hasMetShared(final String name) {
		return meetRec.hasMetShared(name);
	}

	/**
	 * Stores that the player has Met 'name' solo. Overwrites shared meets of
	 * 'name'
	 *
	 * @param name
	 *            of the victim
	...
	public void setSoloMeet(final String name) {
		meetRec.setSoloMeet(name);
	}

	/**
	 * Stores that the player has Met 'name' with help of others. Does not
	 * overwrite solo meets of 'name'
	 *
	 * @param name
	 *            of victim
	 *
	...
	public void setSharedMeet(final String name) {
		meetRec.setSharedMeet(name);
	}

	/**
	 * Returns how much the player has Met 'name' solo.
	 *
	 * @param name
	 *            of the victim
	 * @return number of solo meets
	 */
	public int getSoloMeet(final String name) {
		return meetRec.getSoloMeet(name);
	}

	/**
	 * Returns how much the player has Met 'name' with help of others.
	 *
	 * @param name
	 *            of victim
	 * @return number of shared meets
	 */
	public int getSharedMeet(final String name) {
		return meetRec.getSharedMeet(name);
	}
