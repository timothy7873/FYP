...
public class Hint extends Item {
	...
	private final static Logger logger = Logger.getLogger(Hint.class);
	 ...
	 * @param attributes
	 */
	public Hint(final String name, final String clazz, final String subclass,
