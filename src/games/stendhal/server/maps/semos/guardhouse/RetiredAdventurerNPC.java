		...
		SpeakerNPC npc = new SpeakerNPC("Hayunn Naratha") {
			...
			public void createDialog() {
				...
				add(ConversationStates.IDLE,
				        ...
				        "Hi. I bet you've been sent here to learn about adventuring from me. " +
						"First, lets see what you're made of. Go and kill a rat outside, "+
				        "you should be able to find one easily. Do you want to learn how to attack it, before you go?",
