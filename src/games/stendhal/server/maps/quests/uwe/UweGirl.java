...
//	private static final String QUEST_NAME = "manage_unsolvable_task";
	...
	String images[] = { 
			"https://www3.ntu.edu.sg/home/ehchua/programming/howto/images/JavaErrorClasspath.png",
	...
	private void addDialog() {
		...
		// greeting
		 ...
		 npc.addReply( Arrays.asList("questions", "question"),
					"Questions about DataType and comprasion");
...
//		actions.add(new SetQuestAction(QUEST_NAME, 0, QUEST_OFFERED)); 
	...
	/*	
		npc.add(ConversationStates.IDLE, 
				...
				+ "I have a programming #questions and cannot solve it. Can you help? ",  
				null);
	 */
		/*
		...
		npc.add(ConversationStates.ATTENDING, 
				ConversationPhrases.NO_EXPRESSION, 
				null, 
				ConversationStates.IDLE,
				" Well, maybe someone else will help me. Bye  ",  
				null);
		*/
 
		npc.addJob("My name is Susi and I am a year 1 student."
				+ " I am working on some programming #questions. "
				+ " I almsot finish them but....... "
				);
		npc.addGoodbye("Have fun!");
		npc.addHelp("You may check with the red book on the table and find some professors to talk with");
	//	npc.addOffer("I can offer you m	y #friendship.");
		...
		npc.add(ConversationStates.QUESTION_1, 
				...
				Arrays.asList("A", "a"),
				new QuestInStateCondition(QUEST_SLOT, 0, "completed"),
				 ConversationStates.QUEST_OFFERED,
				"correct" ,
				null
...
/*
		...
		npc.add(ConversationStates.QUEST_OFFERED, "question1", null, ConversationStates.QUEST_OFFERED,
				"I do't know why this does not work " ,
				new ExamineChatAction(images[0], "Unsolvable quest", "Problem about ....")

		);
		
		npc.add(ConversationStates.QUEST_OFFERED, "question2", null, ConversationStates.QUEST_OFFERED,
				"I do't know why this does not work " ,
				new ChatAction() {
					@Override
		...
		npc.add(ConversationStates.ATTENDING, "hint", null, ConversationStates.ATTENDING,
				"You may check with the red book over there",
				null

		);
		
		npc.add(ConversationStates.ATTENDING, "other hint", null, ConversationStates.ATTENDING,
				"Professor at the library will give #examples ",
				null
	...
	*/
	private void addGreetingDependingOnQuestState() {
		npc.add(ConversationStates.IDLE, 
				...
				"These programming #questions are quite challenge but interesting.", 
				null);
/*
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				...
				ConversationStates.ATTENDING, 
				null, 
				new SayTextAction("Hello [name], nice to meet you again. "
	...
	private void addQuest() {
		...
		npc.add(ConversationStates.ATTENDING, 
				...
				oldFriends,
				ConversationStates.ATTENDING, 
				"We should renew our #friendship.",
				null);
		npc.add(ConversationStates.ATTENDING,
				ConversationPhrases.QUEST_MESSAGES, 
				currentFriends,
	...
	*/
	...
	private void addFirstQuest() {
		...
		npc.add(ConversationStates.ATTENDING, 
				Arrays.asList("question", "Questions"), 
				neverAnswer,
		...
		npc.add(ConversationStates.INFORMATION_2, 
				Arrays.asList("2", "3" , "4", "5", "6", "8", "9"), 
				neverAnswer,
				ConversationStates.INFORMATION_2, 
				"I don't think so... it seemes corrrect to me\r\n"+
		...
		/*npc.add(ConversationStates.ATTENDING, 
				...
				noFriends,
				ConversationStates.INFORMATION_1, "Please repeat:\r\n                        \"A circle is round,\"",
				null);
		npc.add(ConversationStates.INFORMATION_1, "",
				new TriggerExactlyInListCondition("A circle is round,", "A circle is round"),
				ConversationStates.INFORMATION_2, "\"it has no end.\"", null);
		npc.add(ConversationStates.INFORMATION_2, "",
				new TriggerExactlyInListCondition("it has no end.", "it has no end"), ConversationStates.INFORMATION_3,
				"\"That's how long,\"", null);
		npc.add(ConversationStates.INFORMATION_3, "", new TriggerExactlyInListCondition("That's how long,",
				"That's how long", "Thats how long,", "Thats how long"), ConversationStates.INFORMATION_4,
		...
		npc.add(ConversationStates.INFORMATION_4, "",
				...
				ConversationStates.ATTENDING, "Yay! We are friends now.", reward);
	*/
		}
	...
	private void addSecondQuest() {
		/*
		npc.add(ConversationStates.ATTENDING, Arrays.asList("friend", "friends", "friendship"), oldFriends,
				ConversationStates.INFORMATION_5, "Please repeat:\r\n                        \"Make new friends,\"",
				null);
		...
		npc.add(ConversationStates.INFORMATION_7, "",
				new TriggerExactlyInListCondition("One is silver,", "One is silver"), ConversationStates.INFORMATION_8,
				"\"And the other gold.\"", null);
		...
		npc.add(ConversationStates.INFORMATION_8, "",
				new TriggerExactlyInListCondition("And the other gold.", "And the other gold", "the other gold.",
						"the other gold"),
				ConversationStates.ATTENDING, "Yay! We are even better friends now.", reward);
	*/
	}
