...
public class UweQuestTwoNPC implements LoadableContent{
	public static String npcName = "UweQuestTwo";
	...
	private final Point spawnPoint = new Point(14,9);
	
	private SpeakerNPC npc;
	
	public UweQuestTwoNPC(){}
	...
	private void addDialog()
	{
		...
		npc.add(ConversationStates.IDLE, 
				...
				"\nI am a quest two NPC, I can provide #quest for you.", 
		...
		npc.add(ConversationStates.INFORMATION_1, 
				...
				ConversationStates.ATTENDING, 
				"Please go find #UweTestTwoNPC to practise java", 
				null);
		npc.add(ConversationStates.INFORMATION_1, 
				Arrays.asList("A bit","a bit","Abit","abit","ab","a"), 
