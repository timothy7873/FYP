...
public class MeetHayunn extends AbstractQuest {
	...
	private void prepareHayunn() {
		...
		npc.add(
				...
				ConversationStates.ATTENDING,
				"Well, back when I was a young adventurer, "
				+ "I clicked on my enemies to attack them. "
				+ "I'm sure that will work for you, too. "
				+ "Good luck, and come back once you are done.",
				null);
