 ...
 * @author hendrik
 */
public class ShowQuestionListEvent extends RPEvent {
	private static final String RPCLASS_NAME = "show_question_list";
	...
	/** the logger instance. */
	private static final Logger logger = Logger.getLogger(ShowQuestionListEvent.class);
	 ...
	 * @param items items
	 */
	public ShowQuestionListEvent(final String title, String caption, final Collection<Item> items) {
		super(RPCLASS_NAME);
